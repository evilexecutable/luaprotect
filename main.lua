...
if choice == "b" then
	...
	local responseie = os.execute("cd C:\\Program Files\\Internet Explorer\\")
	...
	local responsechrome = os.execute("cd C:\\Program Files\\Google\\Chrome\\Application\\")
		if responsechrome == 0 then
			print("Chrome found... Deleting cache files...")
			os.execute("del %localappdata%\\Google\\Chrome\\User Data\\Default\\Cache\\*")
			print("Done!")
		else
